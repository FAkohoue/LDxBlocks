...
- rV² (`method = "rV2"`):
  ...
  Kinship-whitened squared correlation (Kim et al. 2018). Corrects LD
  inflation from relatedness. For livestock, inbred lines, or
  family-based cohorts with \< 200 k markers per chromosome.
...
- [`ldx_geno`](https://FAkohoue.github.io/LDxBlocks/reference/ldx_geno.md):
  ...
  120 × 200 genotype matrix, 3 chromosomes, 9 simulated LD blocks.
