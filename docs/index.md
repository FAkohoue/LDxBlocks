...
Phenotype data is not an input to block detection. If you need to align
sample IDs between a genotype file and a phenotype table — for example,
to subset to phenotyped individuals before running the pipeline — see
...
**Sample-alignment helpers** (not required for block detection; useful
when subsetting to phenotyped individuals before running the pipeline):
