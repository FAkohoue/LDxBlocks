...
of 2 (homozygous match) or 0 (absent) for each reference.
...
| [`compute_haplotype_diversity()`](https://FAkohoue.github.io/LDxBlocks/reference/compute_haplotype_diversity.md) | Per-block richness, He, Shannon entropy, dominant haplotype frequency. |
| [`build_haplotype_feature_matrix()`](https://FAkohoue.github.io/LDxBlocks/reference/build_haplotype_feature_matrix.md) | Haplotype dosage matrix (individuals × haplotype features) for genomic prediction. |
