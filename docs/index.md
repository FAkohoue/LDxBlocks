...
segmentation algorithm of Kim et al. (2018) with 12 concrete
improvements:
...
| [`prepare_gblup_inputs()`](https://FAkohoue.github.io/LDxBlocks/reference/prepare_gblup_inputs.md) | Align phenotype data and GRM for external GBLUP tools. |
| [`run_haplotype_prediction()`](https://FAkohoue.github.io/LDxBlocks/reference/run_haplotype_prediction.md) | Full Tong et al. (2025) pipeline from BLUEs to block importance. |
