...
## These are auto-generated by read_geno() during tests. If they were created
## by SeqArray they will be in SEQ_ARRAY format and incompatible with the
## SNPRelate-based reader. Deleting them here forces clean re-conversion on
## the next test run.
