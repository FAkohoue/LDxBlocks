...
.beagle_works <- function() {
  ...
  tryCatch({
    ...
    # Using LDxBlocks:::.write_cleaned_vcf is avoided here because it
...
# Access the internal function via LDxBlocks:::.write_cleaned_vcf
.wcv <- LDxBlocks:::.write_cleaned_vcf
