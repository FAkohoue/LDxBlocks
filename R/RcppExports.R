...
extract_chr_haplotypes_phased_cpp <- function(hap1_chr, hap2_chr, snp_pos, block_sb, block_eb, min_snps, min_freq, top_n, na_char = ".") {
    .Call(`_LDxBlocks_extract_chr_haplotypes_phased_cpp`, hap1_chr, hap2_chr, snp_pos, block_sb, block_eb, min_snps, min_freq, top_n, na_char)
}
